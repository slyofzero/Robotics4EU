    ...
    return function(e) {
            ...
            p = function(e) {
                function t(n, o, a) {
                    function l() {
                        ...
                        _["default"].isNaN(e) || h.setValue(e)
                    }

                    function s() {
                        l(), h.__onFinishChange && h.__onFinishChange.call(h, h.getValue())
                    }

                    function u(e) {
                        document.activeElement.blur();
                        var t = m - e.clientY;
                        h.setValue(h.getValue() + t * h.__impliedStep), m = e.clientY
                    }

                    function d() {
                        c["default"].unbind(window, "mousemove", u), c["default"].unbind(window, "mouseup", d)
                    }

                    function f(e) {
                        c["default"].bind(window, "mousemove", u), c["default"].bind(window, "mouseup", d), m = e.clientY
                    }
                    i(this, t);
                    var p = r(this, e.call(this, n, o, a));
                    p.__truncationSuspended = !1;
                    var h = p,
                        m = void 0;
                    return p.__input = document.createElement("input"), p.__input.setAttribute("type", "text"), c["default"].bind(p.__input, "change", l), c["default"].bind(p.__input, "blur", s), c["default"].bind(p.__input, "mousedown", f), c["default"].bind(p.__input, "keydown", function(e) {
                        13 === e.keyCode && (h.__truncationSuspended = !0, this.blur(), h.__truncationSuspended = !1)
                    }), p.updateDisplay(), p.domElement.appendChild(p.__input), p
                }
                return a(t, e), t.prototype.updateDisplay = function() {
                    return c["default"].isActive(this.__input) ? this : (this.__input.value = this.__truncationSuspended ? this.getValue() : l(this.getValue(), this.__precision), e.prototype.updateDisplay.call(this))
                }, t
            }(u["default"]);
        t["default"] = p
    }, function(e, t, n) {
        ...
        var s = n(12),
            ...
            f = function(e) {
                function t(n, o, a, s, u) {
                    ...
                    function f(e) {
                        e.preventDefault();
                        var t = c["default"].getOffset(h.__background),
                            n = c["default"].getWidth(h.__background);
                        return h.setValue(l(e.clientX, t.left, t.left + n, h.__min, h.__max)), !1
                    }
            ...
            y = function(e) {
                function t(n, o) {
                    ...
                    function d() {
                        ...
                        e !== !1 ? (v.__color.__state = e, v.setValue(v.__color.toOriginal())) : this.value = v.__color.toString()
                    }
                    ...
                    function _() {
                        v.__onFinishChange && v.__onFinishChange.call(v, v.__color.toString())
                    }

                    function h(e) {
                        e.preventDefault();
                        var t = f["default"].getWidth(v.__saturation_field),
                            n = f["default"].getOffset(v.__saturation_field),
                            o = (e.clientX - n.left + document.body.scrollLeft) / t,
                            i = 1 - (e.clientY - n.top + document.body.scrollTop) / t;
                        return i > 1 ? i = 1 : i < 0 && (i = 0), o > 1 ? o = 1 : o < 0 && (o = 0), v.__color.v = i, v.__color.s = o, v.setValue(v.__color.toOriginal()), !1
                    }

                    function b(e) {
                        e.preventDefault();
                        var t = f["default"].getHeight(v.__hue_field),
                            n = f["default"].getOffset(v.__hue_field),
                            o = 1 - (e.clientY - n.top + document.body.scrollTop) / t;
                        return o > 1 ? o = 1 : o < 0 && (o = 0), v.__color.h = 360 * o, v.setValue(v.__color.toOriginal()), !1
                    }
                    i(this, t);
                    var y = r(this, e.call(this, n, o));
                    y.__color = new p["default"](y.getValue()), y.__temp = new p["default"](0);
                    var v = y;
                    y.domElement = document.createElement("div"), f["default"].makeSelectable(y.domElement, !1), y.__selector = document.createElement("div"), y.__selector.className = "selector", y.__saturation_field = document.createElement("div"), y.__saturation_field.className = "saturation-field", y.__field_knob = document.createElement("div"), y.__field_knob.className = "field-knob", y.__field_knob_border = "2px solid ", y.__hue_knob = document.createElement("div"), y.__hue_knob.className = "hue-knob", y.__hue_field = document.createElement("div"), y.__hue_field.className = "hue-field", y.__input = document.createElement("input"), y.__input.type = "text", y.__input_textShadow = "0 1px 1px ", f["default"].bind(y.__input, "keydown", function(e) {
                    ...
                    return g["default"].extend(y.__selector.style, {
                        width: "122px",
                        height: "102px",
                        padding: "3px",
                        backgroundColor: "#222",
                        boxShadow: "0px 1px 3px rgba(0,0,0,0.3)"
                    }), g["default"].extend(y.__field_knob.style, {
                        position: "absolute",
                        width: "12px",
                        height: "12px",
                        ...
                        borderRadius: "12px",
                        zIndex: 1
                    }), g["default"].extend(y.__hue_knob.style, {
                        position: "absolute",
                        width: "15px",
                        height: "2px",
                        borderRight: "4px solid #fff",
                        zIndex: 1
                    }), g["default"].extend(y.__saturation_field.style, {
                        width: "100px",
                        height: "100px",
                        ...
                        height: "100%",
                        background: "none"
                    }), l(w, "top", "rgba(0,0,0,0)", "#000"), g["default"].extend(y.__hue_field.style, {
                        width: "15px",
                        height: "100px",
                        border: "1px solid #555",
                        cursor: "ns-resize",
                        ...
                        top: "3px",
                        right: "3px"
                    }), s(y.__hue_field), g["default"].extend(y.__input.style, {
                        outline: "none",
                        textAlign: "center",
                        color: "#fff",
                        border: 0,
                    ...
                    }), f["default"].bind(y.__saturation_field, "mousedown", a), f["default"].bind(y.__field_knob, "mousedown", a), f["default"].bind(y.__hue_field, "mousedown", function(e) {
                ...
                return a(t, e), t.prototype.updateDisplay = function() {
                    ...
                    }), this.__hue_knob.style.marginTop = 100 * (1 - this.__color.h / 360) + "px", this.__temp.s = 1, this.__temp.v = 1, l(this.__saturation_field, "left", "#fff", this.__temp.toString()), g["default"].extend(this.__input.style, {
        ...
        function a(e, t, n) {
            if (n.__li = t, n.__gui = e, G["default"].extend(n, {
                ...
                var e = new R["default"](n.object, n.property, {
                    min: n.__min,
                    max: n.__max,
                    step: n.__step
                });
                ...
                var o = function(t) {
                    return G["default"].isNumber(n.__min) && G["default"].isNumber(n.__max) ? (n.remove(), s(e, n.object, n.property, {
                        before: n.__li.nextElementSibling,
                        factoryArgs: [n.__min, n.__max, n.__step]
                    })) : t
                };
                n.min = G["default"].compose(o, n.min), n.max = G["default"].compose(o, n.max)
                ...
                e.stopPropagation()
            })) : n instanceof L["default"] ? (z["default"].bind(t, "click", function() {
            ...
            })) : n instanceof H["default"] && (z["default"].addClass(t, "color"), n.updateDisplay = G["default"].compose(function(e) {
        ...
        function s(e, t, n, o) {
            ...
            var r = void 0;
            if (o.color) r = new H["default"](t, n);
            else {
            ...
            return z["default"].addClass(c, oe.CLASS_CONTROLLER_ROW), r instanceof H["default"] ? z["default"].addClass(c, "color") : z["default"].addClass(c, g(r.getValue())), a(e, c, r), e.__controllers.push(r), r
        }
        ...
        function f(e) {
            ...
            e.load && e.load.remembered ? G["default"].each(e.load.remembered, function(t, n) {
                d(e, n, n === e.preset)
            }) : d(e, J, !1), z["default"].bind(a, "change", function() {
        ...
        function h(e, t) {
            var n = {};
            return G["default"].each(e.__rememberedObjects, function(o, i) {
                var r = {},
                    a = e.__rememberedObjectIndecesToControllers[i];
                G["default"].each(a, function(e, n) {
        ...
        var W = "dg",
            ...
            oe = function ie(e) {
                ...
                var n = this,
                    o = e || {};
                this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), z["default"].addClass(this.domElement, W), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], o = G["default"].defaults(o, {
                    autoPlace: !0,
                    ...
                    preset: J
                } : o.preset && (o.load.preset = o.preset), G["default"].isUndefined(o.parent) && o.hideable && ne.push(this), o.resizable = G["default"].isUndefined(o.parent) && o.resizable, o.autoPlace && G["default"].isUndefined(o.scrollable) && (o.scrollable = !0);
        ...
        oe.toggleHide = function() {
            te = !te, G["default"].each(ne, function(e) {
            ...
            "text" === document.activeElement.type || e.which !== Y && e.keyCode !== Y || oe.toggleHide()
        }, z["default"].bind(window, "keydown", oe._keydownHandler, !1), G["default"].extend(oe.prototype, {
            add: function(e, t) {
                return s(this, e, t, {
            ...
            onResize: G["default"].debounce(function() {
                var e = this.getRoot();
                if (e.scrollable) {
                    ...
                    }), window.innerHeight - t - Q < n ? (z["default"].addClass(e.domElement, oe.CLASS_TOO_TALL), e.__ul.style.height = window.innerHeight - t - Q + "px") : (z["default"].removeClass(e.domElement, oe.CLASS_TOO_TALL), e.__ul.style.height = "auto")
                }
            ...
            remember: function() {
                if (G["default"].isUndefined(Z) && (Z = new F["default"], Z.domElement.innerHTML = x["default"]), this.parent) throw new Error("You can only call remember on a top level GUI.");
                var e = this;
            ...
            getSaveObject: function() {
                var e = this.load;
                return e.closed = this.closed, this.__rememberedObjects.length > 0 && (e.preset = this.preset, e.remembered || (e.remembered = {}), e.remembered[this.preset] = h(this)), e.folders = {}, G["default"].each(this.__folders, function(t, n) {
            ...
            saveAs: function(e) {
                this.load.remembered || (this.load.remembered = {}, this.load.remembered[J] = h(this, !0)), this.load.remembered[e] = h(this), this.preset = e, d(this, e, !0), this.saveToLocalStorageIfPossible()
            },
            revert: function(e) {
